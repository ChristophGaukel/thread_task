...
from .functions import _clean_link
...
class Task:
    ...
    def __init__(self, action: Callable, **kwargs):
        ...
        if isinstance(self._action, Task):
            # if action is a Task, start it as a threadless child
    ...
    def start(
        ...
        try:
            ...
            assert _parent is None or isinstance(_parent, Task), \
    ...
    def _start2(self, thread, _parent: 'Task') -> None:
    ...
    def stop(self, _stay_child=False) -> 'Task':
    ...
    def _cont2(self, thread: bool, _parent: 'Task') -> None:
